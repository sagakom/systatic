...
class CompilerTest extends TestCase
{
    ...
    {  
        ...
        $compile = $compiler->compile('./content/tests/markdown_with_frontmatter.md');
    ...
    {
        $compiler = new Compiler();
        $compile = $compiler->compile('./content/tests/markdown_without_frontmatter.md');
        $this->assertSame(true, $compile);
    ...
    {
        $compiler = new Compiler();
        $compile = $compiler->compile('./content/tests/markdown_with_html_inside.md');
